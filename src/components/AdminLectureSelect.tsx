...
type updateFormFunc = <R extends keyof StringLecture>(
  name: R,
  value: StringLecture[R],
) => void;
...
export default function AdminLectureSelect(
  { updateForm, formKey, value, name, children }: AdminSelectProps,
) {
  return (
